...
[![Platform](https://img.shields.io/badge/platform-Windows%20%7C%20macOS-4c9a5f)](#-获取-token-forest)
[![Status](https://img.shields.io/badge/status-public%20beta-e0a458)](#-路线图)
[![Privacy](https://img.shields.io/badge/privacy-local--first-3a7d44)](docs/PRIVACY.zh-CN.md)
...
<img src="assets/banner.zh-CN.png" alt="Token Forest — 在桌面上生长的像素树" width="100%" />
...
<img src="assets/growth-stages.png" alt="从嫩芽到大树的 8 个成长阶段" width="100%" />

### 🌸 四个树种，各有各的世界

在**四个树种——苹果树、樱花树、仙人掌，以及全新的圣诞树**之间成长与切换。每种树都有自己的果实、自己的一套阶段名，以及可获得和装备的专属主题装饰：鸟居、石灯笼、风铃、竹篱笆、秋千、彩灯等等。收获当前树的果实，就会解锁下一个树种。

<img src="assets/species.zh-CN.png" alt="苹果树、樱花树、仙人掌和圣诞树——四个像素树种" width="100%" />
...
<div align="center"><img src="assets/capsule-mode.zh-CN.png" alt="胶囊模式——迷你状态药丸" width="55%" /></div>

### 🏆 全球排行榜（自愿加入）

想比一比？加入[全球排行榜](https://www.tokenforest.com.au)，看看你的森林在全世界排第几——榜上把每个人自己的树按地区插旗、一字排开，按养出的 token 总量排名。完全自愿：App 内的同意弹窗会列出同步的全部字段，退出排行榜时会从榜上删除你的记录。

<img src="assets/leaderboard.png" alt="全球排行榜——按玩家养进树里的 token 总量排名" width="100%" />

### 🪪 给你的排名配一枚 README 徽章

每个上榜的玩家都有一枚实时 **README 徽章**——它以你的 token 总量打头，显示你的全球排名，并画出你当前正在养的那个树种。在 App 里切换主力树，徽章也会跟着换。

<div align="center">
<img src="assets/badge-cactus.svg" alt="Token Forest 徽章——仙人掌，第 1 名" width="47%" />&nbsp;
<img src="assets/badge-christmas.svg" alt="Token Forest 徽章——圣诞树，第 2 名" width="47%" />
<br/>
<img src="assets/badge-cherry.svg" alt="Token Forest 徽章——樱花，第 3 名" width="47%" />&nbsp;
<img src="assets/badge-apple.svg" alt="Token Forest 徽章——苹果树，第 4 名" width="47%" />
</div>

在 App 里获取你的徽章：排行榜菜单里的**徽章设置**会复制一段指向*你自己*徽章的代码——把它贴进任意 GitHub 仓库的 README（用和你用户名同名的仓库能做出一张漂亮的主页名片）。*上方的名字与排名仅为示例。*

### 📊 数据面板 —— 已随 App 上线

给你的森林配一张"成绩单"：种植天数、累计 token、历史成长曲线、**按厂商**的花费拆分、26 周活跃热力图、按项目分账，以及每次对话一行的账单——外加一份**完全离线**、按内置价目表计算的真实成本估算（四类 token 分开计价，缓存读按 0.1× 折算）。它现在会给**你实际用的每一个模型**计价——不只是 Claude 和 Codex，还包括经你的 CLI 接入的 DeepSeek、Kimi、GLM、Qwen、MiniMax 等。
...
| （仅排行榜、仅自愿）同步同意弹窗列出的字段——仅此而已 | 上传除此之外的任何东西 |
...
| | |
| --- | --- |
| ✅ 已上线 | 实时 token 追踪（Claude Code + Codex）· 8 阶段成长 · **4 个树种（含 🎄 圣诞树）与装饰** · 果实与商店 · 气泡 · 胶囊模式 · **数据面板**（多厂商计价）· 自愿排行榜 **+ README 徽章** · Windows & macOS · 中 / 英 / 日 / 韩 |
| 🚧 进行中 | 一键安装包 · **🌲 下一个树种** |
...
| <img src="https://github.com/EthanMa727.png" width="48" /> | **Ethan Ma** | [@EthanMa727](https://github.com/EthanMa727) |
