...
想比一比？加入[全球排行榜](https://www.tokenforest.com.au)，看看你的森林在全世界排第几——榜上把每个人自己的树按地区插旗、一字排开，按养出的 token 总量排名。完全自愿：只上传昵称、地区、当前树种、树的 token 总量和成长阶段——退出排行榜时，你的记录会被彻底删除。
...
| （仅排行榜、仅自愿）上传昵称、地区、当前树种、token 总量、成长阶段 | 上传除此之外的任何东西 |
